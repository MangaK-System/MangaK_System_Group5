        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Reader"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverFile = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    NameFile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NameFilePublicId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishPeriod = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SeriesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
